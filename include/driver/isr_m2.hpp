...
#include "multibot_ros2_interface/msg/driver_status_stamped.hpp"
#include "multibot_ros2_interface/srv/driver_command.hpp"
...
namespace isr_m2_driver
{
	...
	{
	public:
		using RobotStatusStamped = multibot_ros2_interface::msg::DriverStatusStamped;
		using RobotCommand = multibot_ros2_interface::srv::DriverCommand;
	...
	private:
			...
			: Node("isr2_m2_driver_node"), serial_(io)
		{
			...
			this->get_parameter_or("odom_frame", odom_frame_, std::string("odom"));
