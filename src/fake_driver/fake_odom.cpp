...
void ISR_M2::FakeOdom::command_velocity_callback(
...
void ISR_M2::FakeOdom::update_callback()
{
...
void ISR_M2::FakeOdom::calculate_odometry(const rclcpp::Duration &_duration)
{
    ...
    : Node("FakeOdom")
{
    ...
    RCLCPP_INFO(this->get_logger(), "ISR M2 Fake Odometry has been initialized");
}

ISR_M2::FakeOdom::~FakeOdom()
{
    RCLCPP_INFO(this->get_logger(), "ISR M2 Fake Odometry has been terminated");
}